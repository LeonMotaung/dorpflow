<?php
/**
 * DorpFlow ERP - Forgot Password Request View
 */
?>
<style>
...
<div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh; padding-top: 100px; padding-bottom: 40px;">
    <div class="forgot-card overflow-hidden">
        ...
        <div class="text-center py-4 border-bottom bg-white">
            ...
            <p class="mb-0 text-muted mt-2" style="font-size:0.75rem; font-weight:700; letter-spacing:0.05em;">PASSWORD RECOVERY</p>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <?php if (isset($success)): ?>
                <div class="alert alert-success" role="alert">
                    <i class="fa-solid fa-envelope-circle-check me-2"></i> <?php echo $success; ?>
                </div>
                
                <?php if (isset($reset_url)): ?>
                    <!-- Dev helper simulation box -->
                    <div class="card border-warning bg-warning-subtle p-3 mb-4 rounded-3 text-start" style="font-size:0.8rem;">
                        <span class="d-block fw-bold text-warning-emphasis mb-1"><i class="fa-solid fa-terminal me-1"></i> Local Dev Simulated Reset Link:</span>
                        <code style="word-break:break-all;"><a href="<?php echo $reset_url; ?>" class="text-primary fw-semibold"><?php echo $reset_url; ?></a></code>
                    </div>
                <?php endif; ?>
            <?php endif; ?>

            <form action="<?php echo APP_URL; ?>/public/index.php/forgot-password<?php echo isset($_GET['tenant']) ? '?tenant=' . urlencode($_GET['tenant']) : ''; ?>" method="POST">
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                
                <div class="mb-4">
                    <label for="forgotEmail" class="form-label">Official / Personal Email</label>
                    <input type="email" name="email" class="form-control" id="forgotEmail" placeholder="e.g. citizen@gmail.com" required>
                    <span class="text-muted d-block mt-2" style="font-size:0.75rem;">Enter your email to search the municipality directories and request a recovery token.</span>
                </div>

                <button type="submit" class="btn btn-custom btn-primary-custom w-100 py-3 mb-2">Request Recovery Link</button>
            </form>
